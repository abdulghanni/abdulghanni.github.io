...
"use strict";
    ...
    function init(options) {
        ...
        $('.subpages').append('<div id="page-ajax-loaded" class="page-portfolio-loaded animated rotateInDownRight" style="display: none"><div class="preloader"><div class="preloader-animation"><div class="dot1"></div><div class="dot2"></div></div></div></div>');
        ajaxLoader();
    }
    ...
    function ajaxLoader() {
        ...
        function hideContent() {
            ...
            setTimeout(function(){
                ...
                $('#page-ajax-loaded').append('<div class="preloader"><div class="preloader-animation"><div class="dot1"></div><div class="dot2"></div></div></div>');
            }, 500);
        }
